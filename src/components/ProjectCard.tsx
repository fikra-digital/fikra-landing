  ...
  return (
    ...
    rounded-3xl shadow-md p-3 md:p-6 flex flex-col-reverse lg:flex-row items-start justify-between gap-6'>
      ...
      <div className="flex-1 h-full rounded-2xl">
        <Image src={img} alt={title} className="w-full h-full object-fit border dark:border-lines-dark border-lines-light dark:bg-background-dark_extension rounded-2xl" />
      </div>
    </div>
  )
}
